...
<div class="container py-4" style="max-width:420px">
    <h1 class="h4 text-center mb-3">Daftar Customer</h1>
    ...
    <form method="post" action="<?= site_url('register') ?>">
        ...
        <button type="submit" class="btn btn-bm w-100 btn-lg">Daftar</button>
    </form>
    <p class="text-center mt-3 small">Sudah punya akun? <a href="<?= site_url('login') ?>">Login</a></p>
</div>
<?= $this->endSection() ?>
