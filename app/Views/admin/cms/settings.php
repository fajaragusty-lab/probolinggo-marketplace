...
<form method="post" action="<?= site_url('admin/settings') ?>" class="card shadow-sm p-3">
    ...
    <div class="row g-2">
        ...
        <div class="col-md-6"><label class="form-label">Maintenance Mode (0/1)</label><input class="form-control" name="maintenance_mode" value="<?= esc($settings['maintenance_mode'] ?? '0') ?>"></div>
    </div>
